...
PICS = (environ.get('PICS' ,'https://graph.org/file/35cbee26b7ab58a5cbcaf.jpg')).split()
UPTIME = time.time()
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://graph.org/file/35cbee26b7ab58a5cbcaf.jpg")
